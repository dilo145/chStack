 ...
 */
final class Version20240306084512 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE organism_former (organism_id INT NOT NULL, former_id INT NOT NULL, INDEX IDX_9069FCFD64180A36 (organism_id), INDEX IDX_9069FCFD6C20F19 (former_id), PRIMARY KEY(organism_id, former_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
